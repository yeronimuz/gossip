...
/**
 * Test for @link {@link BackendService} A database is required An mqtt server
 * is required
 */
public class BackendServiceTest {
	private static final Logger LOG = LoggerFactory.getLogger(BackendServiceTest.class);
	...
	public static void doSetup() throws Exception {
		...
		// Prepare database
		Gossip gossip = new Gossip(new Date(), "itsmeyouknow", "it's fake news");
